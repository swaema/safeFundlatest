...
<div class="col-md-10 pb-5" style="background-color: #ECF0F4;">
    ...
    <div class="title text-center">
        <h2 class="h3 fw-bold mt-3 " style="font-family: sans-serif;">
            Loan Application
            <a class="btn btn-primary h3 fw-bold mt-3" style="font-family: sans-serif;" href="loanAppSavePage.php">+</a>
        </h2>
    </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <li><a type="button" class="btn btn-warning btnProduct2"
                                                            href="LoanAppEdit.php?edit=<?php echo $loan['id'] ?>">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form method="post" action="" onsubmit="return myConfirm();">
                                                            ...
                                                            <input type="submit" name="Delete"
                                                                class="btn btn-danger btn-sm mb-2" value="Halt">
                                                        </form>
                                                    </li>
                                                </ul>
                                            </div>
...
<script>
    ...
    function myConfirm() {
        var result = confirm("Want to Halt the Loan?");
        if (result == true) {
            return true;
        } else {
            return false;
