...
<div class="col-md-10 pb-5" style="background-color: #ECF0F4;">
    ...
    <div class="title text-center">
        <h2 class="h3 fw-bold mt-3 " style="font-family: sans-serif;">New Users
        </h2>
    </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <!-- <li><button type="button" class="btn btn-warning mb-2 btn-sm btnProduct2"
                                                    ...
                                                    <li>
                                                        <form method="post" action="" onsubmit="return myConfirm();">
                                                            <input type="hidden" name="id"
                                                                value="<?php echo htmlspecialchars($user['id']); ?>">
                                                            <button type="submit" class="btn btn-sm btn-danger btn-sm mb-2"
...
<script>
    ...
    function myConfirm() {
        var result = confirm("Want to Suspend the User's Account?");
        if (result == true) {
            return true;
        } else {
            return false;
